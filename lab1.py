...
pyplot.plot(X, W, color="blue", linewidth = 1,label="Смоделированная весовая функция")
#pyplot.plot(X, one, label = "Единичное ступенчатое воздействие", color = "green")
#pyplot.plot(X,HA, label = "Аналитически расчитанная переходная функция", linestyle="dashed", color = "black", linewidth = 1)
pyplot.plot(X,WA, label = "Аналитически расчитанная весовая функция",linestyle="dashed", color = "black", linewidth = 1)
